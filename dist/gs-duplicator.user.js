...
const pipelineSchedulesPage = () => __awaiter(void 0, void 0, void 0, function* () {
    const glGraphqlClient = shared_1.GitlabGraphqlClient.getInstance();
    const fullPath = (0, shared_1.getProjectFullPath)(window.location.pathname);
    const [pipeLineIds, _] = yield Promise.all([
    ...
    for (const [index, btnItem] of Array.from(deleteBtns).entries()) {
        ...
        const duplicateBtn = (0, components_1.DuplicateBtnComponent)(pipeLineIds[index]);
        if (duplicateBtn) {
            duplicateBtn.insertBefore(delBtn);
            const downloadEnvFileBtn = (0, components_1.DownloadEnvBtnComponent)(pipeLineIds[index]);
...
class GitlabGraphqlClient extends http_client_base_1.HttpClient {
    ...
    getPipelineScheduleIdsQuery(projectPath) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (_c = (_b = (_a = res === null || res === void 0 ? void 0 : res.project) === null || _a === void 0 ? void 0 : _a.pipelineSchedules) === null || _b === void 0 ? void 0 : _b.nodes) === null || _c === void 0 ? void 0 : _c.map((node) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CreateGitlabScheduleVariableTypes = exports.GitlabScheduleVariableTypes = void 0;
var GitlabScheduleVariableTypes;
(function (GitlabScheduleVariableTypes) {
    GitlabScheduleVariableTypes["ENV_VAR"] = "Variable";
...
var CreateGitlabScheduleVariableTypes;
(function (CreateGitlabScheduleVariableTypes) {
    CreateGitlabScheduleVariableTypes["ENV_VAR"] = "env_var";
    CreateGitlabScheduleVariableTypes["FILE"] = "file";
})(CreateGitlabScheduleVariableTypes = exports.CreateGitlabScheduleVariableTypes || (exports.CreateGitlabScheduleVariableTypes = {}));
...
`;
    ...
    const updateData = () => {
        ...
        modalJObject.find('#i-get-the-options-from').val(config_1.getTheOptionsFrom);
        modalJObject.find('#i-schedule-page-auto-show-dropdown').prop('checked', config_1.autoShowDropDown);
        modalJObject
            .find('#i-enable-markdown-var-description')
            .prop('checked', config_1.enableMarkdownVarDescription);
        modalJObject.find('#i-sort-var-by-name').prop('checked', config_1.sortVarByName);
        modalJObject.find('#i-replace-enter-with-n').prop('checked', config_1.replaceEnterWithN);
    ...
    const getValues = () => {
        ...
        let getTheOptionsFrom = shared_1.GetTheOptionsFrom.VAR_DESCRIPTION;
        switch (getTheOptionsFromOption) {
            case 'var_description':
                getTheOptionsFrom = shared_1.GetTheOptionsFrom.VAR_DESCRIPTION;
                break;
            case 'gitlab_variable_options':
                getTheOptionsFrom = shared_1.GetTheOptionsFrom.GITLAB_VARIABLE_OPTIONS;
                break;
            case 'merge_both':
                getTheOptionsFrom = shared_1.GetTheOptionsFrom.MERGE_BOTH;
                break;
            default:
                getTheOptionsFrom = shared_1.GetTheOptionsFrom.VAR_DESCRIPTION;
                break;
...
const editPipelineSchedulePage = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const persistedVariable of persistedVariables) {
        ...
        if ((keyOptions[variableKey] || []).length > 0) {
            variableSecretValueDropdown = (0, components_1.GitlabSelectionComponent)(keyOptions[variableKey] || [], variableSecretValue, 'pipeline-form-ci-variable-value', 'ci_variable_value_field', (value) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.updatePipelineScheduleMutationStr = exports.getPipelineScheduleQueryStr = exports.getPipelineSchedulesQueryStr = exports.getCiConfigVariablesQueryStr = void 0;
...
`;
exports.updatePipelineScheduleMutationStr = `mutation updatePipelineSchedule($input: PipelineScheduleUpdateInput!) {
...
function convertMarkdownToHtml(markdownString) {
    ...
    if (textBetweenBackticks) {
        textBetweenBackticks.forEach((text) => {
            // get the text between backticks
